...
async function scrapeFresh() {
  console.log('🚀 Starting Fresh Lexus Scraper...');
  ...
  try {
    ...
    console.log('🌎 Processing Kentucky...');
    ...
    // Save data
    fs.writeFileSync('Lexus_fresh.json', JSON.stringify(lexusData, null, 2));
    console.log(`💾 Saved to Lexus_fresh.json. Total dealers: ${lexusData.total_dealers}`);
    
  } catch (error) {
    console.error('❌ Error:', error);
  } finally {
    console.log('⏳ Keeping browser open for 60 seconds so you can see the results...');
