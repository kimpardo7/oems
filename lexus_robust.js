...
async function robustLexusScraper() {
  console.log('🚀 Starting Robust Lexus Scraper for All States...');
  ...
  try {
    ...
    for (const [state, zipCodes] of Object.entries(allStates)) {
      ...
      fs.writeFileSync('Lexus_robust.json', JSON.stringify(lexusData, null, 2));
    ...
    console.log('📁 Data saved to Lexus_robust.json');
